    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>Chat Not Allowed 🐞\n\nMy Admin Has Restricted Me From Working in this Group !If you want to know more about it contact owner...</b>',
        ...
        await message.reply_text(
            text=f"<b>›› Thanks for adding me in your group .\n›› Don't forget to make me admin.\n›› If You are facing any doubts regarding using me then click on the below button⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
...
async def disable_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat_, 
            text=f'<b>Hello Friends, \nMy admin has told me to leave this group so i am going! If you wanna add me again contact my owner.</b> \nReason : <code>{reason}</code>',
            reply_markup=reply_markup)
